/**
 * GeneraPdfBollettiniResponse.java
 *
...
public class GeneraPdfBollettiniResponse  implements java.io.Serializable {
    private java.lang.String[] listPdfFilePath;

    private com.seda.payer.notifiche.webservice.dati.Response response;

    public GeneraPdfBollettiniResponse() {
    }
    ...
    /**
     * Gets the listPdfFilePath value for this GeneraPdfBollettiniResponse.
     * 
    ...
    /**
     * Sets the listPdfFilePath value for this GeneraPdfBollettiniResponse.
     * 
    ...
    /**
     * Gets the response value for this GeneraPdfBollettiniResponse.
     * 
     * @return response
     */
    ...
    /**
     * Sets the response value for this GeneraPdfBollettiniResponse.
     * 
     * @param response
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GeneraPdfBollettiniResponse)) return false;
        GeneraPdfBollettiniResponse other = (GeneraPdfBollettiniResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GeneraPdfBollettiniResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://dati.webservice.notifiche.payer.seda.com", ">GeneraPdfBollettiniResponse"));
